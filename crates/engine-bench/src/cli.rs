...
pub struct CommonArgs {
    /// Authenticated Engine API endpoint of the Arc execution node under test.
    #[arg(
        long,
    ...
    /// JWT secret used to authenticate Engine API requests.
    #[arg(long = "jwt-secret", value_name = "PATH")]
